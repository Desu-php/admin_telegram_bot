        ...
        <ul class="nav flex-column">
            ...
            <li class="sidebar-dropdown nav-item">
                ...
                <div class="sidebar-submenu d-none {{(request()->is('advertisings') || request()->is('advertisings/*'))
                    ...
                    <ul>
                        <li class="nav-item"><a class="nav-link {{(request()->is('advertisings') || request()->is('advertisings/*'))?'active':''}}" href="{{route('advertisings.index')}}">Реклама </a> </li>
                        <li class="nav-item"><a class="nav-link {{(request()->is('stats') || request()->is('stats/*'))?'active':''}}" href="{{route('stats.index')}}">Статистика  </a> </li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link {{(request()->is('channels') || request()->is('channels/*'))?'active':''}}" href="{{route('channels.create')}}">
